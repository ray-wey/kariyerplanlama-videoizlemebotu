...
* Ama bu riskli çünkü videolar bu hızla izleseniz bile tamamlandı olarak gözüküyor ancak hoca dikkat ederse videoyu ne kadar sürede bitirdiğinizi görür ve 5dk lik bir video bile 5 saniyede bittiği için hile yaptığınızı anlar. (hızlandırmayı tavsiye etmiyorum. bu botu çalıştırıp pc başından ayrılın ve otomatik izlesin diye yapıldı zaten)
